...
let barmychart = function() {
    //  柱状图
    Chart.defaults.global.defaultFontFamily = 'Comic Sans MS'; //字体漫画风格
    Chart.defaults.global.animation.easing = 'easeOutCubic' //全局动画效果
        // Chart.defaults.global.animation.duration = 0 //remove animation
    var ctx = document.getElementById('myChart').getContext('2d');
    var chart = new Chart(ctx, {
        type: 'line', //先定义，不行宽度无法
        // The data for our dataset
        data: {
            labels: ['一月', '二月', '三月', '四月', '五月', '六月', '七月'],
            datasets: [{
                type: 'line',
                lineTension: 0, //straight curves
                backgroundColor: '#79c3ac',
                borderColor: '#d1dddB',
                order: 1, //图层
                fill: false, //	How to fill the area under the line. See area charts.
                data: [11, 44, 32, 6, 11, 31, 51]
            }, {
                // The type of chart we want to create
                type: 'bar',
                label: 'test',
                order: 2, //图层
                backgroundColor: '#e9c37a',
                data: [33, 21, 22, 37, 59, 29, 45],
                borderWidth: 0
            }, {
                // The type of chart we want to create
                type: 'bar',
...
let canfunc = function() {
    //  日历图
    var timeEchart = echarts.init(document.getElementById('timeEchart'), null, { renderer: 'svg' });
    ...
    if (timeoption && typeof timeoption === 'object') {
        timeEchart.setOption(timeoption);
    }
}
...
let comparison = function() {
    //  对比图
    let comparisonEchart = echarts.init(document.getElementById('comparisonEchart'), null, { renderer: 'svg' });
    var pathSymbols = {
    ...
    if (comparisonoption && typeof comparisonoption === 'object') {
        comparisonEchart.setOption(comparisonoption)
    }
}

let nnading = function() {
    //  南丁格尔图
    var myEChart_v = echarts.init(document.getElementById('myechart'), null, { renderer: 'svg' });
    let eoption = {
        toolbox: {
            feature: {
                saveAsImage: {
        ...
        series: [{
                ...
                center: ['40%', '55%'], //默认中间
                roseType: 'radius',
                color: ['#87b7cd', '#1c6b96', '#61a0a8', '#d48265', '#91c7ae', '#749f83', '#ca8622', '#bda29a', '#6e7074', '#546570', '#d1dddd', '#c4ccd3', '#283b42', ],
    ...
    myEChart_v.setOption(eoption)
}

let escatterfunc = function() {
    var echartscatter = echarts.init(document.getElementById('escatter'), null, { renderer: 'svg' });
    let esatteroption = {
        toolbox: {
            feature: {
                saveAsImage: {
    ...
    echartscatter.setOption(esatteroption)
}

let ebarfun = function() {
    var ebarfun = echarts.init(document.getElementById('ebarchart'), null, { renderer: 'svg' })
    let ebaroption = {
        toolbox: {
            feature: {
                saveAsImage: {
        ...
        series: [{
                name: '蒸发量',
                type: 'bar',
                data: [2.0, 4.9, 7.0, 26.2, 25.6, 76.7, 135.6, 162.2, 32.6, 20.0, 6.4, 3.3],
                itemStyle: { color: '#a6c0cd' },
                markPoint: {
                    data: [
                        { type: 'max', name: '最大值' },
                        { type: 'min', name: '最小值' }
            ...
            },
            {
                name: '降水量',
                type: 'bar',
                itemStyle: { color: '#e9c37a' },
                data: [2.6, 5.9, 9.0, 24.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6.0, 2.3],
                markPoint: {
                    data: [
